...
# route_options = cycle(['Newyork,USA', 'Chennai, India', 'Bengaluru, India', 'London,UK'])

# connected = True
# while connected:
#     try:
#         for i in range(0, 5):
#             routefrom = next(route_options)
#             routeto = next(route_options)
#             if routefrom != routeto:
#                 data = {
#                     "Battery_Level": round(random.uniform(2.00, 5.00), 2),
