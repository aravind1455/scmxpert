...
#         # print(token)
#         # return html.TemplateResponse("dasboard.html", {"request": request,"token":token})
#         # return JSONResponse(content={"access_token": authToken, "username": var["username"], "email": var["email"], "role": var["role"]}, status_code=200)
